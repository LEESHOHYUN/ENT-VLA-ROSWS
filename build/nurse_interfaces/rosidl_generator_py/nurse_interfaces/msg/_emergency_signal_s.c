...
bool nurse_interfaces__msg__emergency_signal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nurse_interfaces.msg._emergency_signal.EmergencySignal", full_classname_dest, 54) == 0);
  }
  nurse_interfaces__msg__EmergencySignal * ros_message = _ros_message;
  {  // header
...
PyObject * nurse_interfaces__msg__emergency_signal__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("nurse_interfaces.msg._emergency_signal");
