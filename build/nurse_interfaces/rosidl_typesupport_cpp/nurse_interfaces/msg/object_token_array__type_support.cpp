...
static const _ObjectTokenArray_type_support_symbol_names_t _ObjectTokenArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nurse_interfaces, msg, ObjectTokenArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nurse_interfaces, msg, ObjectTokenArray)),
  }
};
...
{
  return &::nurse_interfaces::msg::rosidl_typesupport_cpp::ObjectTokenArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nurse_interfaces, msg, ObjectTokenArray)() {
  return get_message_type_support_handle<nurse_interfaces::msg::ObjectTokenArray>();
}
