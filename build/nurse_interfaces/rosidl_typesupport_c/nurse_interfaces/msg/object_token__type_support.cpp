...
static const _ObjectToken_type_support_symbol_names_t _ObjectToken_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nurse_interfaces, msg, ObjectToken)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nurse_interfaces, msg, ObjectToken)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nurse_interfaces, msg, ObjectToken)() {
  return &::nurse_interfaces::msg::rosidl_typesupport_c::ObjectToken_message_type_support_handle;
}
