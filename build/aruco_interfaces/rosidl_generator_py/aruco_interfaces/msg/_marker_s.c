...
bool aruco_interfaces__msg__marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_interfaces.msg._marker.Marker", full_classname_dest, 35) == 0);
  }
  aruco_interfaces__msg__Marker * ros_message = _ros_message;
  {  // header
...
PyObject * aruco_interfaces__msg__marker__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_interfaces.msg._marker");
