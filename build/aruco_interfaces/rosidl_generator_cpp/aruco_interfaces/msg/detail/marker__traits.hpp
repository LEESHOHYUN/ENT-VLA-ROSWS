...
#ifndef ARUCO_INTERFACES__MSG__DETAIL__MARKER__TRAITS_HPP_
#define ARUCO_INTERFACES__MSG__DETAIL__MARKER__TRAITS_HPP_
...
inline void to_yaml(
  const aruco_interfaces::msg::Marker & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const aruco_interfaces::msg::Marker & msg)
{
  return aruco_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<aruco_interfaces::msg::Marker>()
{
  return "aruco_interfaces::msg::Marker";
}

template<>
inline const char * name<aruco_interfaces::msg::Marker>()
{
  return "aruco_interfaces/msg/Marker";
}

template<>
struct has_fixed_size<aruco_interfaces::msg::Marker>
...
template<>
struct has_bounded_size<aruco_interfaces::msg::Marker>
...
template<>
struct is_message<aruco_interfaces::msg::Marker>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ARUCO_INTERFACES__MSG__DETAIL__MARKER__TRAITS_HPP_
