...
#include "aruco_interfaces/msg/detail/marker__rosidl_typesupport_fastrtps_c.h"
...
using _Marker__ros_msg_type = aruco_interfaces__msg__Marker;
...
static uint32_t _Marker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aruco_interfaces__msg__Marker(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aruco_interfaces__msg__Marker;
    is_plain =
      (
...
static size_t _Marker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aruco_interfaces__msg__Marker(
