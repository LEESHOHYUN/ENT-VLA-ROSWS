...
#include "aruco_interfaces/msg/detail/marker_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const aruco_interfaces::msg::Marker &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  aruco_interfaces::msg::Marker &);
size_t get_serialized_size(
  const aruco_interfaces::msg::Marker &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const aruco_interfaces::msg::MarkerArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: markers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      aruco_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aruco_interfaces::msg::MarkerArray & ros_message)
{
  // Member: header
  ...
  // Member: markers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      aruco_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        aruco_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        aruco_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Marker(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = aruco_interfaces::msg::MarkerArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aruco_interfaces::msg::MarkerArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aruco_interfaces::msg::MarkerArray *>(
    untyped_ros_message);
...
{
  return &aruco_interfaces::msg::typesupport_fastrtps_cpp::_MarkerArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_interfaces, msg, MarkerArray)() {
  return &aruco_interfaces::msg::typesupport_fastrtps_cpp::_MarkerArray__handle;
}
