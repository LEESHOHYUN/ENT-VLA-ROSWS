...
#include "aruco_interfaces/msg/detail/marker__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aruco_interfaces::msg::Marker & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aruco_interfaces::msg::Marker & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aruco_interfaces::msg::Marker;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aruco_interfaces::msg::Marker *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aruco_interfaces::msg::Marker *>(
    untyped_ros_message);
...
{
  return &aruco_interfaces::msg::typesupport_fastrtps_cpp::_Marker__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_interfaces, msg, Marker)() {
  return &aruco_interfaces::msg::typesupport_fastrtps_cpp::_Marker__handle;
}
