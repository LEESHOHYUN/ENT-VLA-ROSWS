...
static const _DelayInfo_type_support_symbol_names_t _DelayInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_robot_manager_interfaces, msg, DelayInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_robot_manager_interfaces, msg, DelayInfo)),
  }
};
...
{
  return &::ur_robot_manager_interfaces::msg::rosidl_typesupport_cpp::DelayInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ur_robot_manager_interfaces, msg, DelayInfo)() {
  return get_message_type_support_handle<ur_robot_manager_interfaces::msg::DelayInfo>();
}
