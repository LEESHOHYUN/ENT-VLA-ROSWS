...
#include "gripper_interfaces/srv/detail/gripper_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gripper_interfaces::srv::GripperControl_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.pos_ctrl_param;
  }
  // Member: vel_ctrl_param
  {
    cdr << ros_message.vel_ctrl_param;
  }
  // Member: torque_ctrl_param
  {
    cdr << ros_message.torque_ctrl_param;
  }
  // Member: custom_input
  cdr << ros_message.custom_input;
  // Member: gripper_init
  cdr << ros_message.gripper_init;
  // Member: grasping_vel
  cdr << ros_message.grasping_vel;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gripper_interfaces::srv::GripperControl_Request & ros_message)
{
  // Member: control_mode
  cdr >> ros_message.control_mode;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.pos_ctrl_param[0]);
  ...
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.vel_ctrl_param[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: torque_ctrl_param
  {
    ...
    size_t item_size = sizeof(ros_message.torque_ctrl_param[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: custom_input
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gripper_interfaces::srv::GripperControl_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gripper_interfaces::srv::GripperControl_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gripper_interfaces::srv::GripperControl_Request *>(
    untyped_ros_message);
...
{
  return &gripper_interfaces::srv::typesupport_fastrtps_cpp::_GripperControl_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gripper_interfaces, srv, GripperControl_Request)() {
  return &gripper_interfaces::srv::typesupport_fastrtps_cpp::_GripperControl_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_gripper_interfaces
cdr_serialize(
  const gripper_interfaces::srv::GripperControl_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: successed
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gripper_interfaces::srv::GripperControl_Response & ros_message)
{
  // Member: successed
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = gripper_interfaces::srv::GripperControl_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gripper_interfaces::srv::GripperControl_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<gripper_interfaces::srv::GripperControl_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &gripper_interfaces::srv::typesupport_fastrtps_cpp::_GripperControl_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gripper_interfaces, srv, GripperControl_Response)() {
  return &gripper_interfaces::srv::typesupport_fastrtps_cpp::_GripperControl_Response__handle;
}
...
{
  return &gripper_interfaces::srv::typesupport_fastrtps_cpp::_GripperControl__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gripper_interfaces, srv, GripperControl)() {
  return &gripper_interfaces::srv::typesupport_fastrtps_cpp::_GripperControl__handle;
}
