...
{
  new (message_memory) gripper_interfaces::srv::GripperCommand_Request(_init);
}

void GripperCommand_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gripper_interfaces::srv::GripperCommand_Request *>(message_memory);
  typed_message->~GripperCommand_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperCommand_Request_message_member_array[2] = {
  {
    "command",  // name
    ...
    offsetof(gripper_interfaces::srv::GripperCommand_Request, command),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gripper_interfaces::srv::GripperCommand_Request, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperCommand_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(gripper_interfaces::srv::GripperCommand_Request),
...
{
  return &::gripper_interfaces::srv::rosidl_typesupport_introspection_cpp::GripperCommand_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gripper_interfaces, srv, GripperCommand_Request)() {
  return &::gripper_interfaces::srv::rosidl_typesupport_introspection_cpp::GripperCommand_Request_message_type_support_handle;
}
...
void GripperCommand_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) gripper_interfaces::srv::GripperCommand_Response(_init);
}

void GripperCommand_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gripper_interfaces::srv::GripperCommand_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperCommand_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gripper_interfaces::srv::GripperCommand_Response, successed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperCommand_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(gripper_interfaces::srv::GripperCommand_Response),
...
{
  return &::gripper_interfaces::srv::rosidl_typesupport_introspection_cpp::GripperCommand_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gripper_interfaces, srv, GripperCommand_Response)() {
  return &::gripper_interfaces::srv::rosidl_typesupport_introspection_cpp::GripperCommand_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GripperCommand_service_members = {
  ...
  // see get_service_type_support_handle<gripper_interfaces::srv::GripperCommand>()
...
get_service_type_support_handle<gripper_interfaces::srv::GripperCommand>()
{
  ...
  auto service_type_support =
    &::gripper_interfaces::srv::rosidl_typesupport_introspection_cpp::GripperCommand_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gripper_interfaces, srv, GripperCommand)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<gripper_interfaces::srv::GripperCommand>();
}
