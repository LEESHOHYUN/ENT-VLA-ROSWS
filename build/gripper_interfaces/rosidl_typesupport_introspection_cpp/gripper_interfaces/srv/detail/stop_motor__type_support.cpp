...
{
  new (message_memory) gripper_interfaces::srv::StopMotor_Request(_init);
}

void StopMotor_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gripper_interfaces::srv::StopMotor_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StopMotor_Request_message_member_array[1] = {
  {
    ...
    offsetof(gripper_interfaces::srv::StopMotor_Request, duration),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StopMotor_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(gripper_interfaces::srv::StopMotor_Request),
...
{
  return &::gripper_interfaces::srv::rosidl_typesupport_introspection_cpp::StopMotor_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gripper_interfaces, srv, StopMotor_Request)() {
  return &::gripper_interfaces::srv::rosidl_typesupport_introspection_cpp::StopMotor_Request_message_type_support_handle;
}
...
void StopMotor_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) gripper_interfaces::srv::StopMotor_Response(_init);
}

void StopMotor_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gripper_interfaces::srv::StopMotor_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StopMotor_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gripper_interfaces::srv::StopMotor_Response, successed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StopMotor_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(gripper_interfaces::srv::StopMotor_Response),
...
{
  return &::gripper_interfaces::srv::rosidl_typesupport_introspection_cpp::StopMotor_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gripper_interfaces, srv, StopMotor_Response)() {
  return &::gripper_interfaces::srv::rosidl_typesupport_introspection_cpp::StopMotor_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers StopMotor_service_members = {
  ...
  // see get_service_type_support_handle<gripper_interfaces::srv::StopMotor>()
...
get_service_type_support_handle<gripper_interfaces::srv::StopMotor>()
{
  ...
  auto service_type_support =
    &::gripper_interfaces::srv::rosidl_typesupport_introspection_cpp::StopMotor_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gripper_interfaces, srv, StopMotor)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<gripper_interfaces::srv::StopMotor>();
}
