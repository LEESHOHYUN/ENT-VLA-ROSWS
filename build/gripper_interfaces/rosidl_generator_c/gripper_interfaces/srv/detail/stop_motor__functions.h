...
#ifndef GRIPPER_INTERFACES__SRV__DETAIL__STOP_MOTOR__FUNCTIONS_H_
#define GRIPPER_INTERFACES__SRV__DETAIL__STOP_MOTOR__FUNCTIONS_H_
...
/// Initialize srv/StopMotor message.
/**
...
/// Finalize srv/StopMotor message.
/**
...
/// Create srv/StopMotor message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gripper_interfaces__srv__StopMotor_Request__init().
...
/// Destroy srv/StopMotor message.
/**
 * It calls
 * gripper_interfaces__srv__StopMotor_Request__fini()
...
/// Check for srv/StopMotor message equality.
/**
...
/// Initialize array of srv/StopMotor messages.
/**
...
/// Finalize array of srv/StopMotor messages.
/**
 * It calls
 * gripper_interfaces__srv__StopMotor_Request__fini()
...
/// Create array of srv/StopMotor messages.
/**
 * It allocates the memory for the array and calls
 * gripper_interfaces__srv__StopMotor_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/StopMotor messages.
/**
 * It calls
 * gripper_interfaces__srv__StopMotor_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/StopMotor message array equality.
/**
...
/// Copy an array of srv/StopMotor messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * gripper_interfaces__srv__StopMotor_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gripper_interfaces
...
/**
 * It calls
 * gripper_interfaces__srv__StopMotor_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_gripper_interfaces
...
/**
 * It allocates the memory for the array and calls
 * gripper_interfaces__srv__StopMotor_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_gripper_interfaces
...
/**
 * It calls
 * gripper_interfaces__srv__StopMotor_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GRIPPER_INTERFACES__SRV__DETAIL__STOP_MOTOR__FUNCTIONS_H_
