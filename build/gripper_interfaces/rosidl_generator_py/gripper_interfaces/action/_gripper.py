    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'gripper_interfaces.action.Gripper_Goal')
            logger.debug(
...
class Gripper_Goal(metaclass=Metaclass_Gripper_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.goal_pose = kwargs.get('goal_pose', int())
    ...
    def goal_pose(self, value):
        if __debug__:
            assert \
                ...
                "The 'goal_pose' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'goal_pose' field must be an integer in [-2147483648, 2147483647]"
...
class Metaclass_Gripper_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gripper_interfaces.action.Gripper_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Gripper_Result(metaclass=Metaclass_Gripper_Result):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.final_pose = kwargs.get('final_pose', int())
    ...
    def final_pose(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'final_pose' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'final_pose' field must be an integer in [-2147483648, 2147483647]"
...
class Metaclass_Gripper_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gripper_interfaces.action.Gripper_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Gripper_Feedback(metaclass=Metaclass_Gripper_Feedback):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.current_pose = kwargs.get('current_pose', int())
    ...
    def current_pose(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'current_pose' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'current_pose' field must be an integer in [-2147483648, 2147483647]"
...
class Metaclass_Gripper_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from gripper_interfaces.action import Gripper
...
class Gripper_SendGoal_Request(metaclass=Metaclass_Gripper_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'gripper_interfaces/Gripper_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['gripper_interfaces', 'action'], 'Gripper_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from gripper_interfaces.action._gripper import Gripper_Goal
...
class Metaclass_Gripper_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gripper_interfaces.action.Gripper_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from gripper_interfaces.action import _gripper
...
class Gripper_SendGoal(metaclass=Metaclass_Gripper_SendGoal):
    from gripper_interfaces.action._gripper import Gripper_SendGoal_Request as Request
    from gripper_interfaces.action._gripper import Gripper_SendGoal_Response as Response
...
class Gripper_GetResult_Response(metaclass=Metaclass_Gripper_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'gripper_interfaces/Gripper_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['gripper_interfaces', 'action'], 'Gripper_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from gripper_interfaces.action._gripper import Gripper_Result
...
class Metaclass_Gripper_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gripper_interfaces.action.Gripper_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Gripper_GetResult(metaclass=Metaclass_Gripper_GetResult):
    from gripper_interfaces.action._gripper import Gripper_GetResult_Request as Request
    from gripper_interfaces.action._gripper import Gripper_GetResult_Response as Response
...
class Metaclass_Gripper_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gripper_interfaces.action.Gripper_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Gripper_FeedbackMessage(metaclass=Metaclass_Gripper_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'gripper_interfaces/Gripper_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['gripper_interfaces', 'action'], 'Gripper_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from gripper_interfaces.action._gripper import Gripper_Feedback
...
class Metaclass_Gripper(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gripper_interfaces.action.Gripper')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Gripper(metaclass=Metaclass_Gripper):
    ...
    from gripper_interfaces.action._gripper import Gripper_Goal as Goal
    # The result message defined in the action definition.
    from gripper_interfaces.action._gripper import Gripper_Result as Result
    # The feedback message defined in the action definition.
    from gripper_interfaces.action._gripper import Gripper_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from gripper_interfaces.action._gripper import Gripper_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from gripper_interfaces.action._gripper import Gripper_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from gripper_interfaces.action._gripper import Gripper_FeedbackMessage as FeedbackMessage
